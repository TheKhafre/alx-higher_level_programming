...
In this project, there is a focus on encapsulated skills in Python object-oriented programming
by coding three connected classes to represent rectangles and squares. The test suite tollowed the `unittest` module to test all functionality for each
class. [the Khafre](https://github.com/TheKhafre)
